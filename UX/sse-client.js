/*\
title: $:/plugins/OokTech/Bob/sse-client.js
...
exports.name = "/events/plugins/OokTech/Bob";
exports.after = ["startup"];
exports.synchronous = true;
exports.platforms = ["browser"];
exports.startup = function() {
	// Make sure we're actually being used
	if($tw.syncadaptor.name !== "WebsocketAdaptor") {
		return;
	}
...
function setupEvents(host) {
	if(window.EventSource) {
		var events = new EventSource(host + "events/plugins/OokTech/Bob");
